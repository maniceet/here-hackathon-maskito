...
def mask_detector():
    if request.method == 'POST':
        ...
        # read the image in PIL format
            ...
            #out_image = json.dumps(str(out_image))
            #out_image =base64.b64encode(out_image)
            #print(type(out_image))
            out_image =base64.b64encode(out_image)
            output = {"image": out_image.decode('utf-8'), "no_people": n_people, "no_people_with_mask":n_mask,
